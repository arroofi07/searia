...
class AgeGroupPetunjukSheet implements FromArray, ShouldAutoSize, WithTitle
{
    ...
    public function array(): array
    {
        return [
            ...
            [''],
            ['Satu baris = satu kelompok umur. Nama boleh bebas (Searia1), kode 1–6 agar terhubung dengan Excel nomor lomba.'],
            ['Tahun lahir tidak boleh tumpang tindih. Grup yang sudah punya pendaftaran tidak boleh diubah tahun lahirnya.'],
            [''],
            ['KODE', 'Unik di kejuaraan ini, maksimal 10 karakter. Pakai 1–6 untuk grup baku.'],
            ['NAMA', 'Nama tampilan, misalnya Group 1 atau Searia1'],
            ['LABEL CETAK', 'Opsional. Biasanya Romawi I–VI di buku acara'],
