...
Acuan: [07-import-excel.md](../07-import-excel.md) bagian Export, [02-fitur.md](../02-fitur.md) F-PAN-18, F-PEL-11
...
Acuan : [../02-fitur.md](../02-fitur.md) F-PEL-11
Perkiraan : M
...
Kriteria selesai:
- [ ] Pelatih dapat mengunduh seluruh sertifikat atletnya dalam satu berkas zip
- [ ] Panitia dapat mengunduh seluruh sertifikat kejuaraan
...
- [ ] Pelatih tidak dapat mengunduh sertifikat klub lain

Uji:
- Feature test pelatih klub A menerima 403 saat meminta arsip klub B
- Feature test dengan `Queue::fake()` memastikan job terkirim
